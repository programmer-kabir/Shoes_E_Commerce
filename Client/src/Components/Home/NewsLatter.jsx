...
const NewsLatter = () => {
  ...
  return (
    <Content>
    <div className="mt-16 object-cover rounded bg-gradient-to-r from-blue-700 via-transparent to-transparent relative w-full h-[500px]"
      style={{
        backgroundImage: `linear-gradient(41deg, #8080 0%, rgba(0, 95, 172, 0) 100%), url(${backgroundImageUrl})`,
        backgroundSize: 'cover',
      }}>
      <div className="pt-24 pl-12  space-y-3 text-white relative  h-full object-none">
        <h2 className="text-4xl font-semibold mb-4">Step into Style with Shoes Website</h2>
        ...
        <div className='w-[550px] bg-gray-200 flex py-1 rounded items-center'>
            <input placeholder='example@gmail.com' type="email" name="" className='bg-gray-200 w-[550px] text-xl  px-3 outline-none text-black' id="" />
