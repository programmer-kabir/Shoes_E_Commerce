...
const Banner = () => {
  ...
  return (
    <Content>
      ...
      <div className="relative rounded-md h-[500px]">
      <video
        autoPlay
        loop
        muted
      ...
      <div className="absolute inset-0 flex items-center justify-center z-10">
        <div className="text-white mr-20 space-y-2">
          <h1 className="text-3xl md:text-4xl font-bold">
            Enjoy Up To $100 <br />Off Fire Pits
          </h1>
      ...
      <div className="absolute inset-0 flex items-center justify-center z-2 text-white text-center">
        <div className="text-start mr-20 space-y-2">
          <h1 className="lg:text-2xl font-bold">Win The Weekend With Pi Prime </h1>
      ...
      <div className="absolute inset-0 flex items-center justify-center z-2 text-white text-center">
        <div className="text-start mr-20 space-y-2">
          ...
          <p className="">All the essentials to get the most out of your Solo Stove.</p>
