              ...
              <div className="pt-4 px-2">
                ...
                <div>
                  <div className="grid grid-cols-2 gap-2 text-center items-center justify-center py-2">
                      ...
                      <NavLink className='bg-gray-400 text-center px-1 text-base font-medium text-white w-full py-3 rounded' to="/s">Rewards</NavLink>
                      <NavLink className='bg-gray-400 text-center px-1 text-base font-medium text-white w-full py-3 rounded' to="/s">Gift Cards</NavLink>
                      <NavLink className='bg-gray-400 text-center px-1 text-base font-medium text-white w-full py-3 rounded' to="/s">Product Finder</NavLink>
                      <NavLink className='bg-gray-400 text-center px-1 text-base font-medium text-white w-full py-3 rounded' to="/s">Community</NavLink>
                      <NavLink className='bg-gray-400 text-center px-1 text-base font-medium text-white w-full py-3 rounded' to="/s">Help</NavLink>
                      {user ? (
                        <button
                          onClick={handleLogOut}
                          className="text-black hover:text-red-700  px-2"
                        ...
                        <NavLink className='bg-gray-400 text-center px-1 text-base font-medium text-white w-full py-3 rounded' to="/sign-in">Login</NavLink>
                      )}
